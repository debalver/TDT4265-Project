# Original file downloaded from: https://github.com/pytorch/vision/blob/master/torchvision/models/inception.py
...
class Inception3(nn.Module):
    ...
    def _forward(self, x):
        ...
        # N x 192 x 71 x 71
        x = F.max_pool2d(x, kernel_size=3, stride=2)
        # First feature to be selected, after basic convolutions, 192 channels 35x35 size
        features.append(x)
        # N x 192 x 35 x 35
        x = self.Mixed_5b(x)
        # N x 256 x 35 x 35
        ...
        # N x 288 x 35 x 35
        x = self.Mixed_5d(x)
        # Second feature to be selected, after inception block A, 288 channels, 35x35 size
        features.append(x)
        # N x 288 x 35 x 35
        x = self.Mixed_6a(x)
        # Third feature, after inception block B, 768 channels, 17x17
        features.append(x)
        # N x 768 x 17 x 17
        x = self.Mixed_6b(x)
        # N x 768 x 17 x 17
        ...
        if aux_defined:
            ...
            aux = None
        # N x 768 x 17 x 17
        # Fourth feature, after inception block C, 768 channels, 17x17 size
        features.append(x)
        x = self.Mixed_7a(x)
        # Fifth feature, after inception block D, 1280 channels, 8x8 size
        features.append(x)
        # N x 1280 x 8 x 8
        x = self.Mixed_7b(x)
        # N x 2048 x 8 x 8
